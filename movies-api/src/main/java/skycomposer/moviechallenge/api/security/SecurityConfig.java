    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/movie-journeys", "/api/movie-courses").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/movies/*/rank-history").hasAnyRole(MOVIES_ADMIN, MOVIES_USER)
                        .requestMatchers(HttpMethod.GET, "/api/movies/*").hasAnyRole(MOVIES_ADMIN, MOVIES_USER, MOVIES_GUIDE)
